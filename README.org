...
This project seeks to explore common notions of movement and information between macro-level architecture (urban planning) and the microarchitecture of the massively parallel processors that feed ever-growing demand for compute resources. Of particular interest are the following computational architectural motifs (that I think may have parallels in urban spaces): (potentially) a lack of verticality / a pervasive 'flatness',
